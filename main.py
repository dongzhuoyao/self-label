...
def get_parser():
    ...
    parser.add_argument('--batch-size', default=bs, type=int, help='batch size (default: 256)')
    ...
    # SK algo
    parser.add_argument('--nopts', default=nopts, type=int, help='number of pseudo-opts (default: 100)')
    parser.add_argument('--augs', default=augs, type=int, help='augmentation level (default: 3)')
    ...
    # architecture
    parser.add_argument('--arch', default=arch, type=str, help='alexnet or resnet (default: alexnet)')
    ...
    parser.add_argument('--workers', default=workers, type=int,help='number workers (default: 6)')
    parser.add_argument('--imagenet-path', default=imagenet_path, help='path to folder that contains `train` and `val`', type=str)
    parser.add_argument('--comment', default=comment, type=str, help='name for tensorboardX')
